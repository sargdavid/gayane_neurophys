...
write.csv(data.table(lbl = unique(dt_fp$lbl),
           short = LETTERS[1:length(unique(dt_fp$lbl))]),
           file = "tmp/ttt1.csv")

dt_fp$lbl <- factor(dt_fp$lbl,
                    levels = rev(unique(dt_fp$lbl)),
                    labels = rev(LETTERS[1:length(unique(dt_fp$lbl))]))
